							...
							&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">
								<s:if test="#order.state == 1">
									<a href="${ pageContext.request.contextPath }/order_findByOid.action?oid=<s:property value="#order.oid" />" 
														style="text-decoration: underline;margin-left: 300px;"><button>付款</button></a>&nbsp;&nbsp;
									<a href="${ pageContext.request.contextPath }/order_cancel.action?oid=<s:property value="#order.oid" />"><button>取消</button></a>&nbsp;&nbsp;
									<a href="${ pageContext.request.contextPath }/order_delete.action?oid=<s:property value="#order.oid" />"><button>删除</button></a>
								</s:if>
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								...
								<td>
									...
									手机：<s:property value="#order.phone" /></br>
									地址：<s:property value="#order.addr" />
								</td>
							</tr>
						</s:iterator>
					</s:iterator>
