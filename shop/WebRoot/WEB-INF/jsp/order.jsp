			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							...
							<s:if test="#session.receiveName != null">
								收货地址：<input name="addr" type="text" value="${receiveAddr }" style="width:350px" />
									<br />
								收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${receiveName }" style="width:150px" />
									<br /> 
								联系方式：<input name="phone" type="text" value="${receivePhone }" style="width:150px" />
							</s:if>
							<s:else>
								收货地址：<input name="addr" type="text" value="<s:property value="model.user.addr"/>" style="width:350px" />
									<br />
